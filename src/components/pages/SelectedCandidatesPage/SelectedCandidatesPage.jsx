  ...
  return (
    <MainLayout>
      <Content style={styles.content}>
        <div style={styles.content.pagetitle}>{t('common.selectedCandidates-page.page-title')}</div>
        ...
        <div style={styles.content.hero}>
          ...
          <Panel style={{ display: 'inline-block', width: 588, height: 500, margin: '1em' }}>
            ...
            <div style={styles.content.maintext}>{t('common.selectedCandidates-page.main-text')}</div>
          </Panel>
        </div>
      </Content>
    </MainLayout>
